...
export default class LoginScreen extends Component {
  ...
  constructor(props) {   
    ...
    UserSendImageFuntion = () =>{
 
      const { UserEmail }  = this.state ;
      const { UserPassword }  = this.state ;
      //Imagr form data
      var data = new FormData();
      data.append('image',{source:'./src/img/kitty.jpeg', name: 'kitty.jpeg', type:'image/jpeg'});
    ...
    render() {
        return (         
            <View style={styles.MainContainer}>         
                ...
                />         
                <Button title="Đăng nhập" onPress={this.UserSendImageFuntion} color="#2196F3" />         
